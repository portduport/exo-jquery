...
$(document).ready(function () {
    ...
    let baseID = data.length;

    showDATA(tableDonnes);
...
// Adding a new contact STARTS HERE
    $("#addRow").on('click', function () {
        ...
        tableDonnes.push(newContact);
        console.log(newContact);
        console.log(tableDonnes);
        $('#donnesHERE').find('tr').remove();
        showDATA(tableDonnes);
    });
...
// Sort the name table STRATS HERE
    let $table = $("#contact");
    let $tableBody = $table.find("#donnesHERE");
    let rows, sortedRows, NomAZ, NomZA, sortAscendingNom;
    let $buttons = $("th a");
...
// This must be a hyperlink
    $(".export").on('click', function (event) {
        // CSV
        let args = [$('#home>table'), 'export.csv'];
